  ...
  export function animateById({
    ...
    const loop = async () => {
      for (let i = 0; i < steps.length; i++) {
        ...
        //calling async function inside an loop in an async function pauses the async function
...
//these animations are defined in index.css. Make sure to add it here if you add it there.
...
//just going to leave this leftover code littered here if you don't mind
